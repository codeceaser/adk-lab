"""H0 - task-boundary handover diagnostic, default finish_task instruction.
...
H0 keeps the default handover instruction: "After successfully completing the
requested operation, call finish_task." H1 differs from this file in that one
...
worker = LlmAgent(
    ...
    instruction=(
        ...
        # THE ONLY LINE THAT DIFFERS FROM H1.
        "After successfully completing the requested operation, call"
        " finish_task."
    ),
